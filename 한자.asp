...
<%
	...
	'SQL 작성
	sql = "SELECT 강좌.강좌번호, 가격, 학년, 권장진도, 유형, 강사.이름, 강좌명 FROM 강좌,강사 WHERE 강좌명 like '%한자%' AND 강사.강사번호=강좌.강사번호"
	Set Rs=Dbcon.Execute(sql)
	response.write("<b>한자 강좌 </b>")
	response.write("<div id='한자 강좌'>")
		...
		<table>
			<tr>
				...
				<form action="강좌신청.asp" method="get">	
						...
						<td><input type="button" value="신청하기" onclick= (href="강좌신청.asp")></td>
