...
<%
	...
	'SQL 작성
	sql = "select distinct 책.제목, 책.판매가, 책.책번호 from 책 where 제목 like '%제2외국어%' "
	Set Rs=Dbcon.Execute(sql)
	response.write("<b>제2외국어 책 </b>")
	response.write("<div id='제2외국어책'>")
...
<div id="content">
      <table>
         <tr>
            ...
            <form action="제2외국어책결제.asp" method="post">
