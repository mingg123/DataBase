...
<%
	...
	'SQL 작성
	sql = "SELECT 강좌.강좌번호, 가격, 학년, 권장진도, 유형, 강사.이름, 강좌명 FROM 강좌,강사 WHERE 강좌명 like '%제2외국어%' AND 강사.강사번호=강좌.강사번호"
	Set Rs=Dbcon.Execute(sql)
	response.write("<b>제2외국어 강좌 </b>")
	response.write("<div id='제2외국어 강좌'>")
